...
const ComboCard = ({ combo, quantity, onIncrease, onDecrease }: { combo: ICombo, quantity: number, onIncrease: () => void, onDecrease: () => void }) => {
  return (
    <div className="relative bg-white/5 backdrop-blur-sm rounded border border-white/10 hover:border-yellow-300/50 overflow-hidden hover:border-yellow-300 transition-all">
