    ...
    variants: {
      variant: {
        ...
        transparentToYellowOrange: `
          ...
          after:bg-gradient-to-r after:from-yellow-500 after:to-orange-500
          after:translate-x-[-100%] hover:after:translate-x-0 focus:text-white focus:after:translate-x-0
          after:duration-500 [&_*]:z-20
        `,
      },
      size: {
