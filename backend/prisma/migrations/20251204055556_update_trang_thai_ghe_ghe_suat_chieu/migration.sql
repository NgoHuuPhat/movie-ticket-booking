/*
  ...
  - The values [DangDuocChon] on the enum `TRANGTHAIGHE` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TRANGTHAIGHE_new" AS ENUM ('DangTrong', 'KhongSuDung', 'TamGiu', 'DaDat');
